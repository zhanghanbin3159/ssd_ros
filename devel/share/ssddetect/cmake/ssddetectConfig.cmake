...
if("TRUE" STREQUAL "TRUE")
  set(ssddetect_SOURCE_PREFIX /media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/src/SSDdetect)
...
if(NOT "/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/devel/include;/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/src/SSDdetect/include;/usr/include " STREQUAL " ")
  set(ssddetect_INCLUDE_DIRS "")
  set(_include_dirs "/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/devel/include;/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/src/SSDdetect/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ssddetect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/src/SSDdetect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/devel/lib;/media/ziwei/Harddisk02/HanBin/TOOL/workspace_C++/Detect/devel/lib;/opt/ros/kinetic/lib)
